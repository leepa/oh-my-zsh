...
This verson of @oh-my-zsh@ has a couple of extra features:

1. Adds a mercurial prompt - you need the "hg-prompt":http://stevelosh.com/projects/hg-prompt/ plugin installed

2. Adds an editor plugin stolen from @zshkit@ which makes text mate integration work
...
@wget http://github.com/leepa/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/leepa/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":http://wiki.github.com/leepa/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
